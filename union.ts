//The Currency type doesn't work for the type of value in the narniaCurrency variable. //Change the Currency type into a union type that works for both the variables.
